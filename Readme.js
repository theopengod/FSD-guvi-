...
//cd desktop or docuents
//mkdir (new files)
//cd (new files)(folder name to open )
/* open the folder in vs code- code . or open vs code and open folder
check the version of git by using git -v in terminal in vs code
once it is success open github web and create new repositary by giving a name to connect local and web files
copy the url of the repositary
config the git user name
